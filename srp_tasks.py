...
# -------------------------
# 2) Abstract TaskStorage class (ตามหลัก OCP)
# -------------------------
...
# -------------------------
# 3) FileTaskStorage (Concrete class สำหรับจัดการไฟล์)
# -------------------------
        ...
        try:
            with open(self.filename, "r") as f:
                for line in f:
                    ...
                    if len(parts) == 5:  # เปลี่ยนจาก 4 เป็น 5 เนื่องจากเพิ่ม priority
                        task_id = int(parts[0])
                        description = parts[1]
...
# -------------------------
# 4) TaskManager class (ปรับปรุงให้ใช้ Dependency Injection)
# -------------------------
class TaskManager:
